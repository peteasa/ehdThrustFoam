...
int main(int argc, char *argv[])
{
    ...
    scalar minO4pLimI = 1e-6;
    scalar minO2pLimI = 1e-6;
    ...
    scalar O4pTargetMin = max(minO4pLimI, minO4pLim);
    scalar O2pTargetMin = max(minO2pLimI, minO2pLim);
    ...
    scalar maxDRhoEDtRateThrRunning = 5e9;
    ...
    while (runTime.loop())
    {
        ...
        if (0 < maxNe && 0 < maxO4p && 0 < maxO2m)
        {
            ...
            O4pTargetMin = min(max(minO4pLimI, minO4pLim), maxO4p);
            O2pTargetMin = min(max(minO2pLimI, minO2pLim), maxO2p);
            ...
            if ( ratioThr == denRatioThr )
            {
                ...
                if (Pstream::master() && (neRatioThr < neRatioHThr
                                          ...
                                          || O2mRatioThr < O2mRatioHThr)) Info << "ERROR: neRatioHThr: " << neRatioHThr
                                            ...
                                            << nl << "O4pRatioHThr: " << O4pRatioHThr
                                            << " O4pRatioThr: " << O4pRatioThr
                                            << " O2pRatioHThr: " << O2pRatioHThr
                                            << " O2pRatioThr: " << O2pRatioThr
                                            << nl << "O2mRatioHThr: " << O2mRatioHThr
